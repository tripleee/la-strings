...
class FrTFIDF
   ...
   private:
      ...
      bool modified ;
   protected:
      FrSymHashTable *hashTable() const { return ht ; }
      FrSymHashEntry *tfidfRecord(FrSymbol *term) const
	 { return ht->lookup(term) ; }
   ...
   public:
      ...
      bool knownWord(FrSymbol *term) const { return ht->lookup(term) != 0 ; }
