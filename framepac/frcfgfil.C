...
/*		2005,2006,2008,2009,2010,2011,2012 Ralf Brown		*/
   ...
   if (curr_state != 0)
	 ...
	 switch (vartype)
	    ...
	    case basedir:
	       {
	       const char *dir
		  = (loc && loc != (void*)this) ? *((char**)loc) : base_dir ;
	       output << '"' << (dir?dir:"") << '"' ;
	       }
	       break ;
	    case filename:
	    ...
	    case yesno:
	       {
	       char value = loc ? *((char*)loc) : (char)0 ;
	       output << (value ? "Yes" : "No") ;
	       }
	       break ;
	    case keyword:
