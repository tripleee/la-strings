...
/*  LastEdit: 09aug12							*/
/*									*/
/*  (c) Copyright 1996,1997,1998,1999,2000,2001,2003,2006,2012		*/
/*		 Ralf Brown						*/
...
{
   FrProgError("used FrNetworkServer subclass in line mode without\n"
	       "overriding onLineReceived") ;
   return false ;
}
...
{
   FrProgError("used FrNetworkServer subclass in object mode without\n"
	       "overriding onObjectReceived") ;
   return false ;
}
#ifdef __GNUC__
