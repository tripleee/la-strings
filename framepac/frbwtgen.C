...
/*  LastEdit: 23may12							*/
/*									*/
/*  (c) Copyright 2003,2004,2006,2008,2012 Ralf Brown			*/
...
static bool mark_dummysym(const FrObject *obj, va_list)
{
...
static bool update_vocabulary(const FrObject *obj, va_list args)
{
   FrSymbol *sym = (FrSymbol*)obj ;
