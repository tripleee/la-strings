...
static FramepaC_error_handler invalid_function_handler = 0 ;
static FramepaC_error_handler missedcase_handler = 0 ;
...
static void fatal_error(const char *message) _fnattr_noreturn ;
...
static void prog_error(const char *message) _fnattr_noreturn ;
...
static void out_of_memory(const char *message) _fnattr_noreturn ;
