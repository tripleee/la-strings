...
/*  LastEdit: 21nov2013	   						*/
/*									*/
/*  (c) Copyright 1994,1995,1996,1997,1998,2002,2006,2009,2013		*/
/*		 Ralf Brown						*/
...
void (*FramepaC_shutdown_peermode_func)() = 0 ;
...
{
   if (object && object->symbolp() && (FrSymbol *)object == symbolNIL)
      return true ;
   else
      return false ;
}
